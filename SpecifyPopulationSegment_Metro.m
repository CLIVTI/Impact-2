function Population=SpecifyPopulationSegment_Metro()
...
Population.TotalPopulation.CarCompetition=0.6; 
Population.TotalPopulation.NumberCars=1; 
Population.TotalPopulation.NoCar=0.05; 

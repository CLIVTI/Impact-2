function Population=SpecifyPopulationSegment_Regional()
...
Population.TotalPopulation.HaveCarInHH=0.86;  
Population.TotalPopulation.CarCompetition=0.75.*0.86;   % according to www.demand.ac.uk/wp-content/uploads/2017/03/25-EC1-Tobias-Kuhnimhof.pdf, half of car owning households have as many cars as adults (assuming all have driving license)
Population.TotalPopulation.HouseholdSize=1.99; % data comes from https://www.destatis.de/EN/FactsFigures/SocietyState/Population/HouseholdsFamilies/Tables/Families.html
Population.TotalPopulation.MotherDistance=0.094*70; 

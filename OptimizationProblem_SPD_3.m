function [ObjectiveFunctionBaseline,ObjectiveFunctionFinal,OptimizedDemand_Final,DecisionVariables_Final,UpdatedModel_Final,Elasticity_Final]=OptimizationProblem_SPD_3(Model,DecisionVariable,RailDiscomfort,SeatCapacity,MaxSeatCapacity,BanAvgift,CSorPS)
...
[ObjectiveFunctionBaseline,ObjectiveFunctionNonInteger,OptimizedDemandNonInteger,FinalDecisionVariablesNonInteger,~]=...
    OptimizeSupply_ConstraintReformulation_SPD_3(Model,DecisionVariable,RailDiscomfort,SeatCapacity,MaxSeatCapacity,BanAvgift,CSorPS);
...
[~,ObjectiveFunctionFinal_Low,OptimizedDemand_Low,FinalDecisionVariables_Low,UpdatedModel_Low]=OptimizeSupply_ConstraintReformulation_SPD_3(ModelFrequency_Low,DecisionVariable_Low,RailDiscomfort,SeatCapacity,MaxSeatCapacity,BanAvgift,CSorPS);
...
[~,ObjectiveFunctionFinal_High,OptimizedDemand_High,FinalDecisionVariables_High,UpdatedModel_High]=OptimizeSupply_ConstraintReformulation_SPD_3(ModelFrequency_High,DecisionVariable_High,RailDiscomfort,SeatCapacity,MaxSeatCapacity,BanAvgift,CSorPS);
...
fprintf('%-15s : %+8.2f %+8.2f %+8.2f \n', 'Rail',     60.*1/UpdatedWaitingTime(1)/2.*MaxSeatCapacity(1) , OptimizedDemand_Final.('All_PT_Rail'), OptimizedDemand_Final.('All_PT_Rail')/(60.*1/UpdatedWaitingTime(1)/2.*MaxSeatCapacity(1)))
...
for i=1:length(AlternativeNames)
    fprintf('%-15s : %+8.2f %+8.2f  \n', AlternativeNames{i},   ModelDemand.(AlternativeNames{i}),  OptimizedDemand_Final.(AlternativeNames{i}))

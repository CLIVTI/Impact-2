...
for i=1:length(RailDiscomfort)
    ...
    DiscomfortValue(i)=table2array(GetAttribute(Model,GetSupplyInfo));
end
...
FinalDiscomfortDiff=DiscomfortDiff(Model,DiscomfortValue,ParsedDiscomfort,SeatCapacity,DCValue);
return

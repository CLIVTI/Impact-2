function [ObjectiveFunctionBaseline,ObjectiveFunctionFinal,OptimizedDemand,FinalDecisionVariables,UpdatedModel]=OptimizeSupply_ConstraintReformulation_SPD_3(Model,DecisionVariable,RailDiscomfort,SeatCapacity,MaxSeatCapacity,BanAvgift,CSorPS)
...
RevenueBase=CostPrivatePeakRailBase.*(CapacitatedDemandBaseline.('All_PT_Rail'));
...
OperationalCostBase=(60.*1/WaitingTime(1)/2).*(12953);
...
% fprintf('%-15s : %+8.2f %+8.2f \n', 'Peak_Rail',     OptimizedDemand.('All_PT_Rail')-c(1) , OptimizedDemand.('All_PT_Rail'))
...
RevenueTrialSolution=CostPrivatePeakRailTrialSolution.*(CapacitatedDemandTrialSolution.('All_PT_Rail'));
...
OperationalCostTrialSolution=(60.*1/WaitingTimeTrialSolution(1)/2).*(12953);
...
c(1)=CapacitatedDemandConstraint.('All_PT_Rail')-UpdatedCapacity(1);

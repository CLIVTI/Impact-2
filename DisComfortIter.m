function [ObjectiveFunctionBaseline,ObjectiveFunctionFinal]=DisComfortIter(DC,CSorPSInput)
...
CostScaleParameter=[0.01,0.01];
DCValue=[DC, DC, DC,DC];  % discomfort for DiscomfortPrivatePeakRail; DiscomfortPrivateOffpeakRail; DiscomfortBusinessPeakRail; DiscomfortBusinessOffpeakRail

function ModelStructure=SpecifySupply_Stcokholm_Gothenburg(UserDefinedParameters)

% CostScaleParameter,DCValue,SeatCapacity
...
CostScaleParameter=ParsedUserDefinedParameters.CostScaleParameter;
...
ModelStructure.Supply.Private.Peak.Air('FirstWaitTimePeakAir')=       [-116.*CostScaleParameter(1),                 1.25];   % it is the "Total väntetid på flygplats" in the excel file
...
ModelStructure.Supply.Private.Offpeak.Rail('DiscomfortCostPrivateOffpeakRail') = [-CostScaleParameter(1).*ExtraCostBaseValue(2),                  (DCValue(2)^((1707+99)/(SeatCapacity(2)*12))-1)];
ModelStructure.Supply.Private.Offpeak.Rail('FirstWaitTimeOffpeakRail')=     [-41/60.*CostScaleParameter(1),         FrequencyToWaitTime(12/9)];
ModelStructure.Supply.Private.Offpeak.Rail('InVehPrivateOffpeakRail')=        [-78/60.*CostScaleParameter(1),        3*60];
...
ModelStructure.Supply.Private.Offpeak.Air('FirstWaitTimeOffpeakAir')=       [-116.*CostScaleParameter(1),                1.25];   % it is the "Total väntetid på flygplats" in the excel file
...
ModelStructure.Supply.Business.Peak.Air('FirstWaitTimePeakAir')=       [-312.*CostScaleParameter(2),                 1.25];   % it is the "Total väntetid på flygplats" in the excel file
...
ModelStructure.Supply.Business.Offpeak.Rail('DiscomfortCostBusinessOffpeakRail')=       [-CostScaleParameter(2).*ExtraCostBaseValue(4),               (DCValue(4)^((1707+99)/(SeatCapacity(2)*12))-1)];
ModelStructure.Supply.Business.Offpeak.Rail('FirstWaitTimeOffpeakRail')=     [-218/60.*CostScaleParameter(2),             1/(12/9)*60/2];
ModelStructure.Supply.Business.Offpeak.Rail('InVehBusinessOffpeakRail')=        [-265/60.*CostScaleParameter(2),        3*60];
...
ModelStructure.Supply.Business.Offpeak.Air('FirstWaitTimeOffpeakAir')=       [-312.*CostScaleParameter(2),                 1.25];   % it is the "Total väntetid på flygplats" in the excel file

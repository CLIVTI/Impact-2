function [ObjectiveFunctionBaseline,ObjectiveFunctionFinal,OptimizedDemand_Final,DecisionVariables_Final,UpdatedModel_Final,Elasticity_Final]=OptimizationProblem_SPD_1(Model,DecisionVariable,RailDiscomfort,SeatCapacity,MaxSeatCapacity,BanAvgift,CSorPS)
...
[ObjectiveFunctionBaseline,ObjectiveFunctionNonInteger,OptimizedDemandNonInteger,FinalDecisionVariablesNonInteger,~]=...
    OptimizeSupply_ConstraintReformulation_SPD_1(Model,DecisionVariable,RailDiscomfort,SeatCapacity,MaxSeatCapacity,BanAvgift,CSorPS);
...
[~,ObjectiveFunctionFinal_Low,OptimizedDemand_Low,FinalDecisionVariables_Low,UpdatedModel_Low]=OptimizeSupply_ConstraintReformulation_SPD_1(ModelFrequency_Low,DecisionVariable_Low,RailDiscomfort,SeatCapacity,MaxSeatCapacity,BanAvgift,CSorPS);
...
[~,ObjectiveFunctionFinal_High,OptimizedDemand_High,FinalDecisionVariables_High,UpdatedModel_High]=OptimizeSupply_ConstraintReformulation_SPD_1(ModelFrequency_High,DecisionVariable_High,RailDiscomfort,SeatCapacity,MaxSeatCapacity,BanAvgift,CSorPS);

function [ObjectiveFunctionBaseline,ObjectiveFunctionFinal,OptimizedDemand,FinalDecisionVariables,UpdatedModel]=OptimizeSupply_ConstraintReformulation_SPD_1(Model,DecisionVariable,RailDiscomfort,SeatCapacity,MaxSeatCapacity,BanAvgift,CSorPS)
...
CostPrivatePeakRailBase=Model.Supply.All.Rail('CostRail');
...
OperationalCostBase=(60.*1/WaitingTime(1)/2).*139456*0.7;
...
OperationalCostTrialSolution=(60.*1/WaitingTimeTrialSolution(1)/2).*139456*0.7;
